...
(function ($, CONFIG) {
    ...
    function search (json, keywords) {
        ...
        return {
            ...
            tags: tags.filter(FILTERS.TAG).sort(function (a, b) { return WEIGHTS.TAG(b) - WEIGHTS.TAG(a); }).slice(0, 200), //Changed by Yuk1n0
            posts: posts.filter(FILTERS.POST).sort(function (a, b) { return WEIGHTS.POST(b) - WEIGHTS.POST(a); }).slice(0, 2000)
